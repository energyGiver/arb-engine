"""Quick test for Hyperliquid adapter."""
...
from arb_engine.adapters.perps.hyperliquid import HyperliquidAdapter
...
async def quick_test():
    ...
    adapter = HyperliquidAdapter(
        ...
        wallet_address=settings.hyperliquid_api_wallet_address,
        wallet_private_key=settings.hyperliquid_api_wallet_private_key,
    )

    print("Hyperliquid Adapter Quick Test")
    print("-" * 40)
